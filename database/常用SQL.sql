...
#充提系统库表注释添加
> /home/kerl/backup/fc_database_update.sql
...
#灰度任务清理
delete LOW_PRIORITY from s8_bbs.pw_transforms where dml_time > DATE_ADD(NOW(),interval -10 day) and dml_time < DATE_ADD(NOW(),interval -1 hour);
